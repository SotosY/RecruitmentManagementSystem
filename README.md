...
You can use the `recruitment_system.sql` script located in the `src/main/resources` folder  
...
```bash
  java -jar target/recruitment-system-project-0.0.1-SNAPSHOT.jar
```

Step 6: Run the following lines or run the remaining lines of the `recruitment_system.sql` script
